	...
	Themes = {
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 60, 80)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 80, 100)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 60, 80))
			}),
			["Color Hub 2"] = Color3.fromRGB(0, 70, 90),
			["Color Stroke"] = Color3.fromRGB(0, 100, 120),
